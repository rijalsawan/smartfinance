...
export const AIInsightsContent: React.FC = () => {
          ...
          {healthScore && (
            <Card className="p-4 sm:p-6">
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 mb-3 sm:mb-4">
                  Financial Health Score
                </div>
              ...
              <Card key={index} className="p-4 sm:p-6 animate-pulse">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div className="flex-1 space-y-2 sm:space-y-3">
                    <div className="h-4 sm:h-5 bg-neutral-200 dark:bg-neutral-700 rounded w-3/4"></div>
                    <div className="h-3 sm:h-4 bg-neutral-200 dark:bg-neutral-700 rounded w-full"></div>
                    <div className="h-3 sm:h-4 bg-neutral-200 dark:bg-neutral-700 rounded w-2/3"></div>
                  </div>
                </div>
              </Card>
            ))}
          ...
          <div className="space-y-4 sm:space-y-6">
            {filteredInsights.map((insight, index) => (
              ...
              >
                <Card className="p-4 sm:p-6 hover:shadow-lg transition-all duration-300">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className={`p-2 sm:p-3 rounded-xl ${getTypeColor(insight.type)} text-white flex-shrink-0`}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        {insight.metadata?.amount && (
                          <div className="flex items-center space-x-1 text-base sm:text-lg font-semibold text-neutral-900 dark:text-white">
            ...
            {filteredInsights.length === 0 && !loading && (
              <Card className="p-8 sm:p-12 text-center">
                <Brain className="w-12 h-12 sm:w-16 sm:h-16 text-neutral-400 mx-auto mb-4" />
